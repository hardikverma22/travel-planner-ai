    ...
    <SectionWrapper id="weather">
      ...
      {weatherData && weatherData.cod != 404 ? (
        <div className="grid md:grid-cols-2 grid-cols-1 grid-flow-row justify-center items-center min-h-[100px] gap-5">
          <div className="rounded-xl w-full h-full flex flex-col justify-center items-center p-5 shadow-md">
            ...
            <div className="flex justify-center items-center gap-1">
              ...
              />
              <span className="text-4xl font-semibold">{Math.round(weatherData.main.temp)}°</span>
            </div>
            <span className="capitalize text-muted-foreground text-sm">
              {weatherData.weather[0].description}
            </span>
          </div>
          <div className="rounded-xl w-full h-full flex flex-col justify-center items-center gap-2 p-5 shadow-md">
            <div className="flex justify-center items-center">
              <span>Wind</span>
            </div>
	...
	c1.147,0.554,2.358,0.818,3.552,0.818c3.035,0,5.95-1.698,7.361-4.613C513.148,503.323,511.449,498.437,507.387,496.472z"
            ...
            <div className="flex items-start justify-center gap-5">
              ...
              <div className="flex justify-center items-center gap-1">
                ...
                <span className="text-sm">{weatherData.wind.deg}°</span>
              </div>
            </div>
          </div>
          <div className="rounded-xl w-full h-full p-5 shadow-md flex flex-col justify-center items-center gap-2 text-sm">
          ...
          <div className="rounded-xl w-full h-full flex justify-center items-center p-5 shadow-md flex-col">
            <div className="flex justify-center items-center">
        ...
        <p>Error loading weather information for {placeName}</p>
      )}
    </SectionWrapper>
  );
};
